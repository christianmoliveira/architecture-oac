...
//		assertEquals(51, arch.getExtbus1().get());
	...
	public void testFillCommandsList() {
        ...
        assertEquals("addRegReg", commands.get(0));
        assertEquals("addMemReg", commands.get(1));
        assertEquals("addRegMem", commands.get(2));
        assertEquals("addImmReg", commands.get(3));

        assertEquals("subRegReg", commands.get(4));
        assertEquals("subMemReg", commands.get(5));
        assertEquals("subRegMem", commands.get(6));
        assertEquals("subImmReg", commands.get(7));

        assertEquals("moveMemReg", commands.get(8));
        assertEquals("moveRegMem", commands.get(9));
        assertEquals("moveRegReg", commands.get(10));
        assertEquals("moveImmReg", commands.get(11));

        assertEquals("inc", commands.get(12));

        assertEquals("jmp", commands.get(13));
        assertEquals("jz", commands.get(14));
        assertEquals("jn", commands.get(15));

        assertEquals("jeq", commands.get(16));
        assertEquals("jneq", commands.get(17));
        assertEquals("jgt", commands.get(18));
        assertEquals("jlw", commands.get(19));

        assertEquals("call", commands.get(20));
        assertEquals("ret", commands.get(21));
	}
